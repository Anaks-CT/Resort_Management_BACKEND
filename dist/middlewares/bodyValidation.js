...
exports.updateUserDetailValidate = exports.wishlistDetails = exports.passwordValidate = exports.emailQueryValidate = exports.bookingRoomDetailsValidate = exports.paramsIdValidate = exports.managerSignupValidate = exports.roomValidate = exports.faqValidate = exports.resortValidate = exports.validateLogin = exports.validateSignup = void 0;
...
exports.updateUserDetailValidate = (0, express_async_handler_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        req.body.updateDetails = yield yupSchema_1.updateUserDetailSchema.validate(req.body.updateDetails);
        next();
    }
    catch (err) {
        throw errorResponse_1.default.badRequest(err.errors[0]);
